...
<table class="table table-hover">
		...
		<tbody>
			<c:forEach items="${list}" var="bo" varStatus="vs">
				<tr>
					<td class="form-group">${vs.count }<inputname="bt_num" value="${bo.bo_num}"></td>
					<td class="form-group">
						<a href="<c:url value='/board/detail'></c:url>"  style="color:black; text-decoration:none;">${bo.bo_title }</a>
					</td>
					<td>${bo.bo_me_id}
					</td>
